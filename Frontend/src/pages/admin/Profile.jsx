 ...
 useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <form onSubmit={handleSubmit} className="bg-white w-full max-w-sm rounded-lg shadow-lg p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <button className="flex-1 bg-yellow-600 text-white py-2 rounded">Save</button>
          <button type="button" onClick={handleLogout} className="flex-1 bg-gray-700 text-white py-2 rounded">
            Logout
          </button>
        </div>
      </form>
...
function Input({ label, ...props }) {
  return (
    <div>
      ...
      <input {...props} className="w-full border rounded p-2 text-sm disabled:bg-gray-100" />
    </div>
  );
}
